...
class Just_The_FAQs_Sanitize {
	...
	public function clean() {
		 ...
		 */
		do_action( 'just-the-faqs-pre-sanitize', $sanitized );
		 ...
		 */
		do_action( 'just-the-faqs-post-sanitize', $sanitized );
	...
	public function set_type( $type ) {
		...
		if ( empty( $type ) ) {
			...
			$check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'just-the-faqs' ) );

		}

		if ( is_wp_error( $check ) ) {

			wp_die( $check->get_error_message(), __( 'Forgot data type', 'just-the-faqs' ) );
